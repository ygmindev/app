...
export type EnvironmentConfigModel = {
  ...
  SERVER_APP_OPENROUTER_SECRET: string;
  ...
  SERVER_STORAGE_BUCKET_ENDPOINT_PUBLIC: string;
  SERVER_STORAGE_BUCKET_ENDPOINT: string;
  SERVER_STORAGE_BUCKET_ID: string;
  SERVER_STORAGE_KEY_ID: string;
  SERVER_STORAGE_KEY_SECRET: string;
