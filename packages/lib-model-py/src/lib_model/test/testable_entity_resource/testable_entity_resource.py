...
class PartialTestableEntityResourceModel(BaseModel):
    pass
...
class RefModelTestableEntityResourceModel(
    RootModel[PartialTestableEntityResourceModel]
):
    root: PartialTestableEntityResourceModel
