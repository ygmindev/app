import { bundleConfig } from '@lib/config/node/bundle/configs/bundle.web.config';
import { testConfig as testConfigFrontend } from '@lib/config/node/test/configs/test.frontend.config';
