...
import { {{NAME}}(constantCase)_OUTPUT_FIELDS } from '@lib/frontend/{{MODULE}}(pathCase)/hooks/use{{NAME}}(pascalCase)Resource/use{{NAME}}(pascalCase)Resource.constants';
import type { Use{{NAME}}(pascalCase)ResourceModel } from '@lib/frontend/{{MODULE}}(pathCase)/hooks/use{{NAME}}(pascalCase)Resource/use{{NAME}}(pascalCase)Resource.models';
