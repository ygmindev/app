...
import { type RangeModel, type ScaledNumberModel } from '#lib-shared/form/form.models';
...
export type RangeFieldPropsModel =
  ...
  | ({ type: FIELD_TYPE.NUMBER | FIELD_TYPE_MORE.NUMBER_POSITIVE } & FieldPropsModel<
      RangeModel<number>
    >)
  | ({ type: FIELD_TYPE_MORE.RELATIVE_DATE } & FieldPropsModel<RangeModel<ScaledNumberModel>>);
