var e=Object.defineProperty,a=(a,t)=>e(a,"name",{value:t,configurable:!0});import{setGlobalContext_prodBuildEntry as t}from"vike/__internal";import{h as o,k as s,C as r,T as n,e as i,L as l,A as p,g,t as d,m as u,R as c,d as f}from"./chunks/chunk-MdWKjDAc.js";import{createInstance as m}from"i18next";import{initReactI18next as h}from"react-i18next";import S from"i18next-fs-backend";import"lodash/trim.js";import"@mikro-orm/core";import"lodash/isPlainObject.js";import"lodash/mergeWith.js";import"lodash/uniq.js";import"lodash/cloneDeep.js";import"app-root-path";import"lodash/trimStart.js";import"path";const v=a((...e)=>o(s,...e),"fromPublic");let P;const b=new r({config:a(({isDebug:e,isPreload:a,language:t,languageDefault:o,languages:s,localePath:r,modules:n})=>{const i=t??o,l={debug:!1,defaultNS:!1,fallbackLng:o,initAsync:!a,interpolation:{escapeValue:!1},lng:i,load:"languageOnly",ns:[],partialBundledLanguages:!a,preload:!!a&&[i],react:{bindI18n:"languageChanged loaded",defaultTransParent:"div",useSuspense:a},supportedLngs:s.map(({id:e})=>e)};if(r){const e=`${r}/locales/{{lng}}/{{ns}}.json`;l.backend={addPath:e,loadPath:e}}let p;return p=P?P.cloneInstance({...l,forkResourceStore:!0,initImmediate:!1}):P=m(l),p.isInitialized||(n?.forEach(e=>p=p.use(e)),p.init(l)),p},"_internationalize"),params:a(()=>({isDebug:!1,isPreload:!1,languageDefault:l,languages:i,modules:[h],timezoneDefault:n}),"params")}).extend(()=>({isPreload:!0,localePath:v(p),modules:[S]})),y=a(({getContext:e,languages:a})=>async({pageContexts:t})=>{const o=[];return a.forEach(({id:a})=>t.forEach(t=>o.push(async()=>{const o=await e({context:t.context,lang:a,pathname:t.urlOriginal});return{...t,context:o.context,urlOriginal:o.pathname}}))),{prerenderContext:{pageContexts:await g(o)}}},"_onPrerender"),j=a(e=>{const{languageDefault:t,languages:o}=b.params(),s=b.config();return y({getContext:a(async({context:e,lang:a,pathname:o})=>{await s.changeLanguage(a);const r=a===t;return console.warn(`@@@pagecontext: ${s.language}`),{context:u([{[f]:{i18n:s,lang:a},[c]:{location:{pathname:d(o)}}},e]),pathname:d(r?o:`/${a}/${o}`)}},"getContext"),languages:o})},"onPrerender")(),T=Object.freeze(Object.defineProperty({__proto__:null,onPrerenderStart:j},Symbol.toStringTag,{value:"Module"})),x={},_={},E={},z=[{pageId:"/src/pages",isErrorPage:void 0,routeFilesystem:{routeString:"/",definedAtLocation:"/src/pages/"},loadVirtualFilePageEntry:a(()=>({moduleId:"virtual:vike:page-entry:server:/src/pages",moduleExportsPromise:import("./entries/src_pages.mjs")}),"loadVirtualFilePageEntry"),configValuesSerialized:{isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},route:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+config.ts",fileExportPathToShowToUser:["default","route"]},valueSerialized:{type:"js-serialized",value:"/*"}},clientRouting:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+config.ts",fileExportPathToShowToUser:["default","clientRouting"]},valueSerialized:{type:"js-serialized",value:!0}}}}],w={configValuesSerialized:{onPrerenderStart:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+onPrerenderStart.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:T}},baseAssets:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+config.ts",fileExportPathToShowToUser:["default","baseAssets"]},valueSerialized:{type:"js-serialized",value:"https://app-web-static-67q4.onrender.com"}},favicon:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+config.ts",fileExportPathToShowToUser:["default","favicon"]},valueSerialized:{type:"js-serialized",value:"https://app-web-static-67q4.onrender.com/assets/favicon/favicon.svg"}}}},D={...Object.assign({})};x[".page"]=D;const O={...Object.assign({})};E[".page"]=O;const k={...Object.assign({})};x[".page.server"]=k;const A={...Object.assign({})};E[".page.server"]=A;const C={...Object.assign({})};_[".page.route"]=C;const U={...Object.assign({})};E[".page.client"]=U;t({virtualFileExportsGlobalEntry:Object.freeze(Object.defineProperty({__proto__:null,neverLoaded:{},pageConfigGlobalSerialized:w,pageConfigsSerialized:z,pageFilesEager:_,pageFilesExportNamesEager:E,pageFilesExportNamesLazy:{},pageFilesLazy:x,pageFilesList:[]},Symbol.toStringTag,{value:"Module"})),assetsManifest:{
  "../../node_modules/.pnpm/vike@0.4.250_react-streaming@0.4.15_react-dom@19.2.3_react@19.2.3__react@19.2.3__vite@7_a4cba15f91f90f8df4d5529a44ec2fad/node_modules/vike/dist/client/runtime-client-routing/entry.js": {
    "file": "assets/entries/entry-client-routing.CHbuwLNZ.js",
  ...
  "_chunk-BZxjT6rl.js": {
    "file": "assets/chunks/chunk-BZxjT6rl.js",
  ...
  "_chunk-BrjrQUnT.js": {
    "file": "assets/chunks/chunk-BrjrQUnT.js",
    "name": "preload-helper"
  },
  ...
  "virtual:vike:page-entry:client:/src/pages": {
    "file": "assets/entries/src_pages.D8G7p-bo.js",
