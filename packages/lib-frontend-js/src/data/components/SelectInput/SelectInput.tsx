...
export const SelectInput = <TType extends string | Array<string> = string>({
  defaultValue,
  elementState,
  isIgnoreAll = false,
  isMultiple,
  ...
  value,
  ...props
}: RLFCPropsModel<SelectInputRefModel, SelectInputPropsModel<TType>>): ReactElement<
  RLFCPropsModel<SelectInputRefModel, SelectInputPropsModel<TType>>
> => {
