import { bundleConfig } from '@lib/config/node/bundle/configs/bundle.frontend.config';
import { testConfig as testConfigBase } from '@lib/config/node/test/configs/test.base.config';
