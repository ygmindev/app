...
export type ResourceServiceBeforeDecoratorModel<
  ...
  TRoot = undefined,
> = (params: {
  input: InputModel<TMethod, TType, TRoot>;
}) => Promise<InputModel<TMethod, TType, TRoot>>;
...
export type ResourceServiceDecoratorModel<TType, TForm, TRoot = undefined> = {
  ...
  beforeCreate?: ResourceServiceBeforeDecoratorModel<RESOURCE_METHOD_TYPE.CREATE, TForm, TRoot>;
  beforeGet?: ResourceServiceBeforeDecoratorModel<RESOURCE_METHOD_TYPE.GET, TType, TRoot>;
  beforeGetConnection?: ResourceServiceBeforeDecoratorModel<
    RESOURCE_METHOD_TYPE.GET_CONNECTION,
    TType,
    TRoot
  >;
  beforeGetMany?: ResourceServiceBeforeDecoratorModel<RESOURCE_METHOD_TYPE.GET_MANY, TType, TRoot>;
  beforeRemove?: ResourceServiceBeforeDecoratorModel<RESOURCE_METHOD_TYPE.REMOVE, TType, TRoot>;
  beforeUpdate?: ResourceServiceBeforeDecoratorModel<RESOURCE_METHOD_TYPE.UPDATE, TType, TRoot>;
};
