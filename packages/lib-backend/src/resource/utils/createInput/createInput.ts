...
export const createInput = <TMethod extends ResourceMethodTypeModel, TType, TForm>({
  Resource,
  method,
  name,
}: CreateInputParamsModel<TMethod, TType, TForm>): CreateInputModel<TMethod, TType, TForm> => {
