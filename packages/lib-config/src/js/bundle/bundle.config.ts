import { _bundleConfig } from '@lib/config/js/bundle/_bundle.config';
import { BUNDLE_MODE } from '@lib/config/js/bundle/bundle.constants';
...
const config: BundleConfigParamsModel =
  require(`@lib/config/node/bundle/configs/bundle.${APP_PLATFORM}.config`).bundleConfig;
