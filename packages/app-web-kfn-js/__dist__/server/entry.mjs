var e=Object.defineProperty,a=(a,t)=>e(a,"name",{value:t,configurable:!0});import{setGlobalContext_prodBuildEntry as t}from"vike/__internal";import{h as s,k as o,C as r,T as i,e as n,L as l,A as p,g as d,t as g,m as u,R as c,d as f}from"./chunks/chunk-MdWKjDAc.js";import{createInstance as m}from"i18next";import{initReactI18next as h}from"react-i18next";import S from"i18next-fs-backend";import"lodash/trim.js";import"@mikro-orm/core";import"lodash/isPlainObject.js";import"lodash/mergeWith.js";import"lodash/uniq.js";import"lodash/cloneDeep.js";import"app-root-path";import"lodash/trimStart.js";import"path";const v=a((...e)=>s(o,...e),"fromPublic");let P;const b=new r({config:a(({isDebug:e,isPreload:a,language:t,languageDefault:s,languages:o,localePath:r,modules:i})=>{const n=t??s,l={debug:!1,defaultNS:!1,fallbackLng:s,initAsync:!a,interpolation:{escapeValue:!1},lng:n,load:"languageOnly",ns:[],partialBundledLanguages:!a,preload:!!a&&[n],react:{bindI18n:"languageChanged loaded",defaultTransParent:"div",useSuspense:a},supportedLngs:o.map(({id:e})=>e)};if(r){const e=`${r}/locales/{{lng}}/{{ns}}.json`;l.backend={addPath:e,loadPath:e}}let p;return p=P?P.cloneInstance({...l,forkResourceStore:!0,initImmediate:!1}):P=m(l),p.isInitialized||(i?.forEach(e=>p=p.use(e)),p.init(l)),p},"_internationalize"),params:a(()=>({isDebug:!1,isPreload:!1,languageDefault:l,languages:n,modules:[h],timezoneDefault:i}),"params")}).extend(()=>({isPreload:!0,localePath:v(p),modules:[S]})),y=a(({getContext:e,languages:a})=>async({pageContexts:t})=>{const s=[];return a.forEach(({id:a})=>t.forEach(t=>s.push(async()=>{const s=await e({context:t.context,lang:a,pathname:t.urlOriginal});return{...t,context:s.context,urlOriginal:s.pathname}}))),{prerenderContext:{pageContexts:await d(s)}}},"_onPrerender"),j=a(e=>{const{languageDefault:t,languages:s}=b.params(),o=b.config();return y({getContext:a(async({context:e,lang:a,pathname:s})=>{await o.changeLanguage(a);const r=a===t;return{context:u([{[f]:{i18n:o,lang:a},[c]:{location:{pathname:g(s)}}},e]),pathname:g(r?s:`/${a}/${s}`)}},"getContext"),languages:s})},"onPrerender")(),T=Object.freeze(Object.defineProperty({__proto__:null,onPrerenderStart:j},Symbol.toStringTag,{value:"Module"})),_={},x={},E={},z=[{pageId:"/src/pages",isErrorPage:void 0,routeFilesystem:{routeString:"/",definedAtLocation:"/src/pages/"},loadVirtualFilePageEntry:a(()=>({moduleId:"virtual:vike:page-entry:server:/src/pages",moduleExportsPromise:import("./entries/src_pages.mjs")}),"loadVirtualFilePageEntry"),configValuesSerialized:{isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},route:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+config.ts",fileExportPathToShowToUser:["default","route"]},valueSerialized:{type:"js-serialized",value:"/*"}},clientRouting:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+config.ts",fileExportPathToShowToUser:["default","clientRouting"]},valueSerialized:{type:"js-serialized",value:!0}}}}],w={configValuesSerialized:{onPrerenderStart:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+onPrerenderStart.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:T}},baseAssets:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+config.ts",fileExportPathToShowToUser:["default","baseAssets"]},valueSerialized:{type:"js-serialized",value:"https://app-web-static-67q4.onrender.com"}},favicon:{type:"standard",definedAtData:{filePathToShowToUser:"/src/pages/+config.ts",fileExportPathToShowToUser:["default","favicon"]},valueSerialized:{type:"js-serialized",value:"https://app-web-static-67q4.onrender.com/assets/favicon/favicon.svg"}}}},D={...Object.assign({})};_[".page"]=D;const O={...Object.assign({})};E[".page"]=O;const k={...Object.assign({})};_[".page.server"]=k;const A={...Object.assign({})};E[".page.server"]=A;const C={...Object.assign({})};x[".page.route"]=C;const U={...Object.assign({})};E[".page.client"]=U;t({virtualFileExportsGlobalEntry:Object.freeze(Object.defineProperty({__proto__:null,neverLoaded:{},pageConfigGlobalSerialized:w,pageConfigsSerialized:z,pageFilesEager:x,pageFilesExportNamesEager:E,pageFilesExportNamesLazy:{},pageFilesLazy:_,pageFilesList:[]},Symbol.toStringTag,{value:"Module"})),assetsManifest:{
  ...
  "_chunk-BEQDyH4F.js": {
    "file": "assets/chunks/chunk-BEQDyH4F.js",
  ...
  "virtual:vike:page-entry:client:/src/pages": {
    "file": "assets/entries/src_pages.goygb1XO.js",
