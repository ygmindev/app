import { MenuOptionModel } from '@lib/frontend/core/components/Menu/Menu.models';
...
const { Component, displayName, testID } = withTestComponent<VirtualizedListPropsModel<MenuOptionModel>>({
