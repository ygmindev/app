...
import { type OptionalCallableModel, type PartialModel } from '#lib-shared/core/core.models';
...
export type EnvironmentOverrideParamsModel = {
  ...
  overrides?: OptionalCallableModel<PartialModel<EnvironmentConfigModel>>;
};
