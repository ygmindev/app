...
import { InternationalizeConfigModel, _InternationalizeConfigModel } from '@lib/config/locale/internationalize/internationalize.models';
...
export const render = async (params: RenderParamsModel): RenderModel => {
  const { _config } = await importConfig<InternationalizeConfigModel, _InternationalizeConfigModel>('locale/internationalize/internationalize');
  return _render({
    ...params,
    Wrapper: (props) => (
